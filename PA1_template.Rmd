...
This is an R Markdown document for my first reproducible research assignment. The below step reads in the datafile.For some basic exploratory steps, I have looked at the length and the average. Lubridate will put the date into the correct format
